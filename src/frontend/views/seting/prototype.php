        ...
        <div class="tab-content">
          <div class="tab-pane active" id="Prototype">
            ...
            <section ng-if="!nowPrototype">
              ...
              <div class="row">
                <div class="col-lg-2 col-sm-4 col-xs-6 ng-cloak" style="height:185px;" ng-repeat="(name,item) in prototypes.red">
                  <div class="small-box" style="cursor: pointer;" ng-class="item.node ? bgList[$index%7] : 'bg-gray'" ng-click="detail(item);">
                    <div class="inner">
                      ...
                      <h3 ng-bind="item.lengthNum" style="height:40px"></h3>
            ...
            <section ng-if="!nowPrototype">
              ...
              <div class="row">
                <div class="col-lg-2 col-sm-4 col-xs-6 ng-cloak" style="height:185px;" ng-repeat="(name,item) in prototypes.green">
                  <div class="small-box" style="cursor: pointer;" ng-class="item.node ? bgList[$index%7] : 'bg-gray'" ng-click="detail(item);">
                    <div class="inner">
                      <h3 ng-bind="item.lengthNum" style="height:40px"></h3>
                      <p ng-bind="item.orgName" style="font-size: 20px;"></p>
